...
- `hypergeometric_1F1(a, b, z)`: \$\$\_1F_1(a, b;z) = \sum\_{n=0}^\infty
  \frac{(a)\_nz^n}{(b)\_n!}\$\$

- `hypergeometric_1F1_regularized(a, b, z)`: \$\$\_1\tilde{F}\_1(a, b;z)
  = \frac{\_1F_1(a, b;z)}{\Gamma(b)}\$\$

- `log_hypergeometric_1F1(a, b, z)`: Numerically stable implementation
  of \\\ln \_1F_1(a, b;z)\\
