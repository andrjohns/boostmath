...
extern "C" {
  ...
  SEXP cardinal_quintic_hermite_aos_init_(SEXP data_, SEXP x0_, SEXP dx_) {
    ...
    using interpolator_t = boost::math::interpolators::cardinal_quintic_hermite_aos<std::vector<std::array<double, 2>>>;
  ...
  SEXP cardinal_quintic_hermite_aos_eval_(SEXP ptr_, SEXP x_) {
    cpp11::external_pointer<boost::math::interpolators::cardinal_quintic_hermite_aos<std::vector<std::array<double, 2>>>> ptr(ptr_);
    double x = boostmath::as_cpp<double>(x_);
